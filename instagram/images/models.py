...
class Comment(TimeStampedModel):
    ...
    creator = models.ForeignKey(user_models.User, on_delete=models.PROTECT, null=True, related_name="comments")
...
class Like(TimeStampedModel):
    ...
    creator = models.ForeignKey(user_models.User, on_delete=models.PROTECT, null=True, related_name="likes")
    image = models.ForeignKey(Image, on_delete=models.PROTECT, null=True)
